...
public class MineTweakerMC {
    ...
    static {
        ...
        for (int i = 0; i < BiomeGenBase.getBiomeGenArray().length; i++) {
            if (BiomeGenBase.getBiomeGenArray()[i] != null) biomes[i] = new MCBiome(BiomeGenBase.getBiomeGenArray()[i]);
        }
    }
    ...
    /**
     * Returns the Minecraft ingredient for this ingredient. This method is only useful for ingredients that represent a
     * single item stack.
     * 
    ...
    /**
     * Converts an array of minetweaker item stacks into an array of minecraft item stacks.
     * 
    ...
    /**
     * Converts a list of minetweaker item stacks into an array of minecraft item stacks.
     * 
    ...
    /**
     * Converts an array of minecraft item stacks into an array of minetweaker item stacks.
     * 
    ...
    /**
     * Converts a list of minecraft item stacks into an array of minetweaker item stacks.
     * 
     * @param items minecraft item stacks
     * @return minetweaker item stacks
     */
    ...
    /**
     * Gets the ore dictionary entry with the given name. If the entry didn't exist yet, it will create it and return an
     * empty entry.
     * 
    ...
    /**
     * Converts a Minecraft NBT to an IData instance. The IData instance is immutable (not modifyiable).
     * 
     * @param nbt nbt data
     * @return IData value
     */
