...
public interface ITweaker {
    ...
    /**
     * Executes a specified MineTweaker action. Will print a log message and adds the action to the undo list.
     * 
    ...
    /**
     * Rolls back all actions performed by MineTweaker. Returns the list of actions that could not be rolled back (the
     * "stuck" ones that are not undoable).
     * 
