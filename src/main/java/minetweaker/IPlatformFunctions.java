...
/**
 * Platform functions are a set of internal functions implemented by the platform intended to communicate between API
 * and implementation.
 * 
 * @author Stan Hebben
 */
public interface IPlatformFunctions {
    ...
    /**
     * Distributes the given script data to all connected clients. Automatically reloads the scripts from this data.
     * 
