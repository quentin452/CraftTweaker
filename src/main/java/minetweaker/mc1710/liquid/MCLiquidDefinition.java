...
public class MCLiquidDefinition implements ILiquidDefinition {
    ...
    /*
     * private void removeContainerInner(IItemStack filled) { ItemStack filledItem = MineTweakerMC.getItemStack(filled);
     * FluidContainerRegistry.FluidContainerData data = filledContainerMap.get(Arrays.asList(filledItem.itemID,
     * filledItem.getItemDamage())); if (data != null) { filledContainerMap.remove(Arrays.asList(filledItem.itemID,
     * filledItem.getItemDamage())); containerFluidMap.remove(Arrays.asList(data.emptyContainer.itemID,
     * data.emptyContainer.getItemDamage())); // rebuild empty containers set emptyContainers.clear(); for
     * (FluidContainerRegistry.FluidContainerData fdata : filledContainerMap.values()) {
    ...
    /*
     * private FluidContainerRegistry.FluidContainerData getData(IItemStack filled) { ItemStack filledStack =
     * MineTweakerMC.getItemStack(filled); return filledContainerMap.get(Arrays.asList(filledStack.itemID,
    ...
    private class AddContainerAction implements IUndoableAction {
        ...
        public void apply() {
            FluidContainerRegistry.registerFluidContainer(
                    ...
                    MineTweakerMC.getItemStack(filled),
                    MineTweakerMC.getItemStack(empty));
        }
    ...
    /*
     * private class RemoveContainerAction implements IUndoableAction { private final IItemStack filled; private final
     * IItemStack empty; private final FluidStack amount; public RemoveContainerAction(IItemStack filled) { this.filled
     * = filled; FluidContainerRegistry.FluidContainerData data = getData(filled); empty =
     ...
     * @Override public void undo() { FluidContainerRegistry.registerFluidContainer(amount,
     * MineTweakerMC.getItemStack(filled), MineTweakerMC.getItemStack(empty)); }
     * @Override public String describe() { return "Removing liquid container " + filled; }
     * @Override public String describeUndo() { return "Restoring liquid container " + filled; }
