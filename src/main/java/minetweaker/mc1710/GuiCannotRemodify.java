...
/**
 * This screen is shown when a client has been modified with a permanent modification and the player logs into a game
 * with a different script. It asks the player to restart the game.
 * 
 * @author Stan Hebben
 */
