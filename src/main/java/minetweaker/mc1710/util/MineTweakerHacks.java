 ...
 * minecraft versions and may need regular adjustment - as such, those have been collected here.
 * 
 * @author Stan Hebben
 */
public class MineTweakerHacks {
    ...
    static {
        ...
        INVENTORYCRAFTING_EVENTHANDLER = getField(
                InventoryCrafting.class,
                MineTweakerObfuscation.INVENTORYCRAFTING_EVENTHANDLER);
        ...
        try {
            forgeSeedEntry = (Class<? extends WeightedRandom.Item>) Class
                    .forName("net.minecraftforge.common.ForgeHooks$SeedEntry");
    ...
    public static BiMap<Class<? extends Entity>, EntityRegistry.EntityRegistration> getEntityClassRegistrations() {
        try {
            return (BiMap<Class<? extends Entity>, EntityRegistry.EntityRegistration>) ENTITYREGISTRY_CLASSREGISTRATIONS
                    .get(EntityRegistry.instance());
    ...
    public static WeightedRandom.Item constructSeedEntry(WeightedItemStack stack) {
        try {
            return SEEDENTRY_CONSTRUCTOR
                    .newInstance(MineTweakerMC.getItemStack(stack.getStack()), (int) stack.getChance());
    ...
    private static Field getField(Class cls, String... names) {
        for (String name : names) {
            try {
                ...
                field.setAccessible(true);
                return field;
            } catch (NoSuchFieldException ex) {} catch (SecurityException ex) {}
        }
