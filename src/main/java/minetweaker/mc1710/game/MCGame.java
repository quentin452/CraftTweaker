...
public class MCGame implements IGame {
    ...
    public void signalLockError() {
        ...
        if (Minecraft.isGuiEnabled()) {
            ...
            /**
             * Minecraft.getMinecraft().displayGuiScreen( new GuiCannotRemodify( "Minecraft has been tweaked for another
             * server", "with modifications that cannot be rolled back.", "Please restart your game."));
             **/
        }
    }
