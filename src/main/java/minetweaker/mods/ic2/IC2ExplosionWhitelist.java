 ...
 * 
 * The explosion code by default ignores blocks which absorb more than 1000 explosion power to prevent abusing personal
 * safes, Trade-O-Mats and other blocks to serve as a cheap and invulnerable reactor chambers. Said blocks will not
 * shield the explosion and won't get destroyed.
 * 
 * @author Stan Hebben
 */
