    ...
    private static class AddBottleIngredientAction extends OneWayAction {
        ...
        public void apply() {
            Recipes.cannerBottle
                    .addRecipe(new IC2RecipeInput(container), new IC2RecipeInput(fill), getItemStack(output));
        }
    ...
    private static class AddBottleLiquidAction extends OneWayAction {
        ...
        public void apply() {
            Recipes.cannerBottle.addRecipe(
                    ...
                    new RecipeInputFluidContainer(((FluidStack) fill.getInternal()).getFluid(), fill.getAmount()),
                    getItemStack(output));
        }
