...
public class ThermalCentrifuge {
     ...
     * 
     * The recipe input can be any ingredient, as long as the stack size is determined. The output is an array of item
     * stacks.
     * 
     ...
     * Adds a new recipe to the centrifuge.
     * 
     * The recipe input can be any ingredient, as long as the stack size is determined. The output can be any item
     * stack.
     * 
