...
public class ScrapBox {
     ...
     *
     * 0.1: Diamond 0.5: Cake, Gold Helmet, Iron Ore, Gold Ore 1.0: Wooden tools, Soul Sand, Sign, Leather, Feather,
     * Bone 1.5: Apple, Bread 2.0: Netherrack, Rotten Flesh 3.0: Grass, Gravel 4.0: Stick 5.0: Dirt, Wooden Hoe
     * 
